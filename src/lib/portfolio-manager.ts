  ...
  private getDefaultData(): PortfolioData {
    return {
      personalInfo: {
        ...
        introduction:
          "Passionate B.Tech 2nd year student at Quantum University with a focus on software development, web technologies, and emerging tech innovations. Always eager to learn and build amazing projects.",
        profileImage: "",
        resumePdf: "",
      ...
      projects: [
        {
          ...
          description:
            "A full-stack e-commerce platform with React frontend and Node.js backend, featuring user authentication, payment integration, and admin dashboard.",
          longDescription:
            "Complete e-commerce solution with modern design, responsive layout, and seamless user experience.",
          technologies: [
            "React",
            "Node.js",
            "MongoDB",
        ...
        },
        {
          ...
          longDescription:
            "Modern task management solution for teams with real-time collaboration.",
        ...
        },
        {
          ...
          description:
            "A responsive weather dashboard showing current weather, forecasts, and interactive maps with beautiful animations.",
          longDescription:
            "Beautiful weather application with modern UI and accurate weather data.",
          technologies: [
            "JavaScript",
            "HTML5",
            "CSS3",
        ...
        },
        {
          ...
          description:
            "This very portfolio website built with React, TypeScript, and Framer Motion, featuring a content management system.",
          longDescription:
            "Personal portfolio with admin panel for content management.",
          technologies: [
            "React",
            "TypeScript",
            "Tailwind CSS",
        ...
        },
        {
          ...
          description:
            "Real-time chat application with group messaging, file sharing, and emoji reactions built with Socket.io.",
          longDescription:
      ...
      certifications: [
        {
          ...
          expiryDate: "",
          verificationUrl:
            "https://freecodecamp.org/certification/darshan/javascript-algorithms-and-data-structures",
        ...
        },
        {
          ...
          verificationUrl:
            "https://aws.amazon.com/verification/cloud-practitioner",
        ...
        },
        {
          ...
          verificationUrl:
            "https://university.mongodb.com/verify/associate-dev",
