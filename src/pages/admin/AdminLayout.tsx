...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      <div className="flex h-full">
        {/* Desktop Sidebar */}
        <aside className="hidden lg:flex lg:w-80 lg:flex-col bg-gray-800/90 backdrop-blur-lg border-r border-gray-700/50">
